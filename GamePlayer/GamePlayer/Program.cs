...
namespace GamePlayer
{
    ...
    {//this is the heavily modified code by me, Aditya. see comments in the code for clarity. If any more questions, then contact me on the email thread.
        ...
        private static void Main(string[] args)
        {
            ...
            int GPUID = 1;// int.Parse(args[0]) - 1;//1;//1;// -1 for Ms hoover0;// 0;//

            string folderName = "warlock-0";// args[1].ToString();//"22-02-2018-23-54-44";// "starter-0";/"starter-0";//
            int numGames = 400;// int.Parse(args[2]);//200;// 100;// 100;//100;//
